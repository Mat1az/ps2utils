...
<main>
    <div class="border-b border-gray-200 dark:border-gray-700 block">
        <ul class="inline-flex -mb-px text-sm font-medium text-center text-gray-500 dark:text-gray-400">
            <li class="me-2">
                <a href="#"
                   class="cursor-not-allowed inline-flex items-center justify-center p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 group">
    ...
    <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mt-10" on:click={select}>Load
        Games
    </button>
            ...
            <tr class="border-b bg-gray-800 border-gray-700">
                ...
                <td>
                    {#if id.length !== 0}
                        {id}
                    {:else}
                        <button value={url} class="hover:bg-slate-700 py-2 px-4 rounded" on:click={(e)=>repair(0,e)}>
                            &#10060;
                        </button>
                    {/if}
                </td>
                ...
                <td>
                    {#if opl}&#9989;
                    {:else}
                        <button value={url} class="hover:bg-slate-700 py-2 px-4 rounded" on:click={(e)=>repair(1,e)}>
                            &#10060;
                        </button>
                    {/if}
                </td>
                <td>
                    {#if hdl}&#9989;
                    {:else}
                        <button value={url} class="hover:bg-slate-700 py-2 px-4 rounded" on:click={(e)=>repair(2,e)}>
                            &#10060;
                        </button>
                    {/if}
                </td>
